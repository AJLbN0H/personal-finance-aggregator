...
from src.utils import (exchange, get_currency_rates, get_currency_rates_by_cbr, get_date, get_user_settings, mask_card,
                       read_excel)
...
def test_exchange(amount: float, currency_code: str, date: datetime.date, func: OUTER, result: float) -> None:
