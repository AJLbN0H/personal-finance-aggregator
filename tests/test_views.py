...
from src.views import (get_cards_info, get_top_transactions, get_user_prefer_currency_rates, get_user_stocks, greeting,
                       main_page)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            {
                "greeting": "",
                "cards": [{"last_digits": "1234", "total_spent": 1800.0, "cashback": 180.0}],
                "top_transactions": [
                    {
                        "date": "11.12.1997",
                        "amount": -600.0,
